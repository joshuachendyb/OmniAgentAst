...
### 12.3 详细改造方案【按通道3→通道1→通道2，G1→G7顺序】
...
#### 12.3.3 G3：修复 _process_description 无差别截断
...
#### 12.3.4 G4：移除 Register 文件中的"参数说明"段落
...
#### 12.3.5 G5：移除 get_system_prompt() 中的 `- Parameters:` 块
...
#### 12.3.6 G6：get_parameter_reminder() 改为自动生成
...
#### 12.3.7 G7：get_all_tools_summary() 去掉参数名
