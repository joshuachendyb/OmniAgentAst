...
- 用于显示当前使用的模型和提供商信息
- 
增加：《对比现在的前端type=start  显示方式是否有需要修改的？
---
...
- 
增加：《对比现在的前端type=thought  显示方式是否有需要修改的？
...
增加：《对比现在的前端type=action_tool  显示方式是否有需要修改的建议说明？
...
增加：《对比现在的前端type=observation  显示方式是否有需要修改的建议说明？
...
增加：《对比现在的前端type=final  显示方式是否有需要修改的建议说明？
---
...
增加：《对比现在的前端type=error  显示方式是否有需要修改的建议说明？
