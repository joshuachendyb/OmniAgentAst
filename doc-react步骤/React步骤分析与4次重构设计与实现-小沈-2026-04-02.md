...
| v4.4 | 2026-04-02 14:05:11 | 小沈 | 全面审查第4/5章：修正字段分类（基本/条件必需/可选），修复chunk基本字段不一致，补充所有type可选字段生成说明 |
