  ...
  return (
    <div
      ...
      style={{
        ...
        padding: '3px 0',
        borderBottom:
          idx < total - 1 ? `1px solid ${Colors.BORDER.LIGHT}` : 'none',
    ...
    >
      ...
      <span
        style={{ flex: 1, color: Colors.TEXT.STRONG, wordBreak: 'break-all' }}
      >
        {name}
      </span>
      ...
      {entry.mtime !== undefined && entry.mtime !== null && (
        <span style={{ color: Colors.BORDER.STRONG, fontSize: 12 }}>
          <InboxOutlined
            style={{ marginRight: 4, color: Colors.BORDER.DEFAULT }}
          />
  ...
  return (
    ...
    >
      ...
      >
        ...
        {isDirectory ? (
          <FolderOutlined
            style={{ marginRight: 6, fontSize: 14, color: Colors.WARNING }}
          />
        ) : (
          <FileOutlined
            style={{ marginRight: 6, fontSize: 14, color: Colors.PRIMARY }}
          />
        )}
        <span
          style={{
  ...
  return (
    <div style={containerStyle}>
      ...
      >
        ...
        {bytes > 0 && (
          <span style={{ color: Colors.TEXT.SECONDARY }}>{bytes} 字节</span>
        )}
