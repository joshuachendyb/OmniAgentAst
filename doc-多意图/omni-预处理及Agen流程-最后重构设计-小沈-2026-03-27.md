...
|-------------|------|----------|------|
| chat | intent_type=="chat" 或 confidence < 0.3 | chat_stream_query() | 简单对话流 |
| file | intent_type=="file" 且 confidence >= 0.3 | FileReactAgent.ver1_run_stream() | 文件操作ReAct |
| network | intent_type=="network" 且 confidence >= 0.3 | NetworkReactAgent.ver1_run_stream() | 网络操作ReAct |
| desktop | intent_type=="desktop" 且 confidence >= 0.3 | DesktopReactAgent.ver1_run_stream() | 桌面操作ReAct |
