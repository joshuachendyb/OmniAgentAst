...
class TestBuildObservationText:
    ...
    def test_success_with_data(self):
        ...
        text = build_observation_text(result)
...
class TestInjectToolsInfo:
    ...
    def test_inject_before_first_non_system(self):
        ...
        result = inject_tools_info(history, "【工具】search_web")
    ...
    def test_inject_no_content_no_change(self):
        ...
        result = inject_tools_info(history, "")
...
class TestCacheManagement:
    ...
    def test_invalidate_cache_not_exists(self):
        """【兼容性】invalidate_cache()已移除"""
        mb = MessageBuilder()
        assert not hasattr(mb, 'invalidate_cache')

    def test_no_cache_methods(self):
        """MessageBuilder无缓存相关方法"""
        mb = MessageBuilder()
        assert not hasattr(mb, 'invalidate_cache')
