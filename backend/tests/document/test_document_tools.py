...
class TestReadDocument:
    ...
    def test_read_pdf_file_not_found(self):
        ...
        assert result["code"] in ["ERR_DOC_READ_PDF", "ERR_DOC_NO_PDFPLUMBER", "ERROR"]

    def test_read_pdf_invalid_path(self):
        """❌ 无效路径"""
        result = read_document("")

        assert result["code"] in ["ERR_DOC_FORMAT_NOT_SUPPORTED", "ERROR"]

    def test_read_docx_file_not_found(self):
        """❌ DOCX文件不存在"""
        result = read_document("D:/not_exist.docx")

        assert result["code"] in ["ERR_DOC_READ_DOCX", "ERR_DOC_NO_DOCX", "ERROR"]
    ...
    def test_read_xlsx_file_not_found(self):
        ...
        assert result["code"] in ["ERR_DOC_READ_XLSX", "ERROR"]
    ...
    def test_read_pptx_file_not_found(self):
        ...
        assert result["code"] in ["ERR_DOC_READ_PPTX", "ERR_DOC_NO_PPTX", "ERROR"]
