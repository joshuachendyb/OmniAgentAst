...
USER_INPUT = (
    "帮我搜一下今天科技圈有什么大新闻和人工智能领域的最新动态，用两个关键词分别搜一下，搜到了把前三条结果的标题和摘要都提取出来，然后分别打开他们的详细内容看看各说了什么，把重要的信息点提取出来做一下对比和汇总，最后把汇总结果保存到E:\\test_dir。把本次任务的分析实施过程和分析结果独立生成四种版本的报告存入report目录下。"
)
