...
@pytest.mark.asyncio
async def test_e2e_unit_06_data_persistence():
    """unit-06: 数据持久化通路 - 列目录验证三张表"""
    ...
    elapsed = 0.0
    error_info = None
    user_input = ('你需要读取任务书"E:\task\task001.txt"的要求,'
        "分析任务的可行性和实施方案,"
    ...
    try:
        ...
        print_report(
            "unit-06", "数据持久化通路验证", result, db, lc,
            ci, si, True, elapsed,
            extra={
