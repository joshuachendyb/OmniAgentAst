"""全链路E2E集成测试 - P0-04b: FILE+NETWORK混合通路验证
...
@pytest.mark.asyncio
async def test_e2e_p0_04b_file_network():
    """P0-04b: FILE+NETWORK混合通路"""
    ...
    try:
        register_pending_record(
            "E2E-P0-04b", "FILE+NETWORK混合通路(Python+React+Go)(04b)",
        ...
        print_report(
            "E2E-P0-04b", "FILE+NETWORK混合通路", result, db, lc,
            ci, si, True, elapsed,
        ...
        write_test_record("E2E-P0-04b", "FILE+NETWORK混合通路(04b)", user_input, r, db, ci, si, lc, passed, r.get("total_time_ms", 0)/1000.0 if r else 0, dpi=dpi, error_info=error_info)

    if passed:
        print(f"\n  [DONE] E2E-P0-04b PASSED")
