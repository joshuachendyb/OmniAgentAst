...
USER_INPUT = (
    "帮我搜索2026年AI领域的最新进展，用2026年AI技术突破和人工智能最新应用两个关键词分别搜索，把每个搜索的前几条结果都打开看看详细内容，从里面提取出最重要的发现和突破，汇总整理成一份详细的研究报告保存到E:\\test_dir\\ai_research_2026.txt，保存完成后给我发一条通知告诉我研究完成。把本次任务的分析实施过程和分析结果独立生成四种版本的报告存入report目录下。"
)
