"""E2E-E2E-P5-10: 搜索发通知
操作手册: NETWORK+DESKTOP组合
预期调用链: search_web(x2)->fetch_webpage(x3)->write_text_file->send_notification
前置数据: 网络连通
...
TEST_CASE_ID = "E2E-P5-10"
TEST_CASE_NAME = "搜索发通知"
USER_INPUT = (
    "这是一项多阶段AI研究搜索与通知任务，请严格按照以下阶段顺序执行。"
    ""
    "【阶段一：多关键词搜索】"
    "第一步，搜索\"2026年AI技术突破\"，获取前5条搜索结果，展示标题、摘要和URL。"
    "第二步，搜索\"人工智能最新应用2026\"，同样获取前5条结果。"
    "第三步，搜索\"大语言模型进展2026\"，获取前5条结果。"
    ""
    "【阶段二：深度内容提取】"
    "第四步，打开第一次搜索的前3条结果，每篇文章提取：文章标题、核心技术突破点、涉及的机构/公司、发布时间。"
    "第五步，打开第二次搜索的前3条结果，提取：应用名称、应用领域、解决的核心问题、上线时间。"
    "第六步，打开第三次搜索的前3条结果，提取：模型名称、参数量、关键性能指标、发布时间。"
    ""
    "【阶段三：Python脚本分析】"
    "第七步，写一个Python脚本对9篇文章做综合分析：统计出现频率最高的技术关键词、"
    "汇总所有提到的公司和机构列表、按时间线排序所有发布事件、"
    "识别出跨文章重复提到的热门技术方向，把综合分析报告保存到E:\\test_dir\\ai_analysis.txt。"
    ""
    "【阶段四：研究报告生成与通知】"
    "第八步，把以上所有信息汇总整理成一份详细的研究报告保存到E:\\test_dir\\ai_research_2026.txt，"
    "报告包含：技术突破章节、应用案例章节、大模型进展章节、综合分析章节和参考文献列表。"
    "第九步，保存完成后获取当前时间作为研究完成时间，然后给我发一条桌面通知告诉研究完成。"
    ""
    "【阶段五：四版本报告】"
...
@pytest.mark.asyncio
async def test_e2e_p5_10_search_notify():
    """E2E-P5-10: 搜索发通知"""
