"""E2E-E2E-P5-03: Shell管理链
操作手册: SHELL组合-查找+执行
预期调用链: execute_shell_command(where)->execute_shell_command(systeminfo)->execute_shell_command(tasklist)->execute_shell_command(start)->execute_shell_command(tasklist)
前置数据: 系统正常运行
...
@pytest.mark.asyncio
async def test_e2e_p5_03_shell_manage():
    """E2E-P5-03: Shell管理链"""
    ...
    try:
        ...
        print_report(
            "E2E-P5-03", "Shell管理链", result, db, lc,
            ci, si, True, elapsed,
