"""E2E-E2E-P5-13: 网络搜索+系统诊断+文件存档
操作手册: NETWORK+SYSTEM+FILE组合
预期调用链: search_web->fetch_webpage->execute_shell_command(systeminfo)->write_text_file
前置数据: 网络连通；系统正常运行
...
@pytest.mark.asyncio
async def test_e2e_p5_13_search_sys_file():
    """E2E-P5-13: 网络搜索+系统诊断+文件存档"""
    ...
    try:
        ...
        print_report(
            "E2E-P5-13", "网络搜索+系统诊断+文件存档", result, db, lc,
            ci, si, True, elapsed,
