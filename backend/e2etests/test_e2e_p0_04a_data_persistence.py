...
async def test_e2e_p0_04a_data_persistence():
    ...
    try:
        ...
        safety_errors = [e for e in lc["errors"] if any(k in e for k in ["安全检查", "拒绝执行", "高风险", "execute_code", "pickle", "RCE", "extract", "create_task", "delete_task", "Permission denied", "DB operation failed", "operation_executor", "edittext failed", "NoneType", "Errno 13", "ERR_SQL_EXEC", "UNIQUE constraint", "拒绝访问", "WinError 5", "readtext failed", "unable to open database"])]
