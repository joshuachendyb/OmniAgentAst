...
class OcrInput(BaseModel):
    ...
    language: Literal["eng", "chi_sim", "eng+chi_sim"] = Field(default="eng", description="识别语言。eng=英文，chi_sim=简体中文，eng+chi_sim=中英混合。默认eng")  # 小健 2026-05-19: str→Literal
...
class SendNotificationInput(BaseModel):
    ...
    duration: int = Field(default=5, ge=1, le=60, description="显示时长（可选），单位为秒，最大60秒。默认5秒")  # 小健 2026-05-19: 加上限
