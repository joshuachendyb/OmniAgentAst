...
TOOL_TIMEOUTS = {
    ...
    "execute_shell_command_foreground": 35,
    "execute_shell_command_background": 5,
    "execute_python": 120,
...
CATEGORY_MODULES = {
    ...
    "dataanalysis": ("app.services.tools.dataanalysis", "_register_dataanalysis_tools"),
    "fundamental": ("app.services.tools.fundamental", "_register_fundamental_tools"),
    "win_registry": ("app.services.tools.win_registry", "_register_registry_tools"),
    "timer": ("app.services.tools.timer", "_register_timer_tools"),
}
