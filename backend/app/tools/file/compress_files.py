...
async def compress(
    ...
    try:
        ...
        if result:
            ...
            safe_data = {k: v for k, v in result.items() if k not in ("source_path", "destination_path", "format", "compressed_size", "file_count", "compressed_files", "original_size", "compression_ratio")}
