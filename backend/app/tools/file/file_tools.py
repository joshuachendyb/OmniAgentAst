...
def _build_compress_files_llm_data(exec_code, duration_ms, source="", detail=""):
    """compress_files的llm_data构建函数 — 小健 2026-06-21"""
    if exec_code == "error":
        return {"summary": f"压缩文件失败: {detail}", "action": {"tool": "compress_files", "tool_zh": "压缩文件", "target": source, "params": {}}, "status": {"exec_code": "error", "message": "压缩失败", "code": "", "detail": detail, "hint": ""}, "duration_ms": duration_ms, "metrics": {}}
    return {"summary": f"压缩文件成功: {source}", "action": {"tool": "compress_files", "tool_zh": "压缩文件", "target": source, "params": {}}, "status": {"exec_code": "success", "message": "压缩成功", "code": "", "detail": "", "hint": ""}, "duration_ms": duration_ms, "metrics": {}}


def _build_extract_archive_llm_data(exec_code, duration_ms, source="", detail=""):
    """extract_archive的llm_data构建函数 — 小健 2026-06-21"""
    if exec_code == "error":
        return {"summary": f"解压文件失败: {detail}", "action": {"tool": "extract_archive", "tool_zh": "解压文件", "target": source, "params": {}}, "status": {"exec_code": "error", "message": "解压失败", "code": "", "detail": detail, "hint": ""}, "duration_ms": duration_ms, "metrics": {}}
    return {"summary": f"解压文件成功: {source}", "action": {"tool": "extract_archive", "tool_zh": "解压文件", "target": source, "params": {}}, "status": {"exec_code": "success", "message": "解压成功", "code": "", "detail": "", "hint": ""}, "duration_ms": duration_ms, "metrics": {}}


def _build_move_file_llm_data(exec_code, duration_ms, source="", detail="", extra_metrics=None):
    """move_file的llm_data构建函数 — 小健 2026-06-21"""
    extra_metrics = extra_metrics or {}
    if exec_code == "error":
        return {"summary": f"移动失败: {detail}", "action": {"tool": "move_file", "tool_zh": "移动", "target": source, "params": {}}, "status": {"exec_code": "error", "message": "移动失败", "code": "", "detail": detail, "hint": ""}, "duration_ms": duration_ms, "metrics": {}}
    return {"summary": f"移动成功: {source}", "action": {"tool": "move_file", "tool_zh": "移动", "target": source, "params": {}}, "status": {"exec_code": "success", "message": "移动成功", "code": "", "detail": "", "hint": ""}, "duration_ms": duration_ms, "metrics": extra_metrics}


def _build_copy_file_llm_data(exec_code, duration_ms, source="", detail="", extra_metrics=None):
    """copy_file的llm_data构建函数 — 小健 2026-06-21"""
    extra_metrics = extra_metrics or {}
    if exec_code == "error":
        return {"summary": f"复制失败: {detail}", "action": {"tool": "copy_file", "tool_zh": "复制", "target": source, "params": {}}, "status": {"exec_code": "error", "message": "复制失败", "code": "", "detail": detail, "hint": ""}, "duration_ms": duration_ms, "metrics": {}}
    return {"summary": f"复制成功: {source}", "action": {"tool": "copy_file", "tool_zh": "复制", "target": source, "params": {}}, "status": {"exec_code": "success", "message": "复制成功", "code": "", "detail": "", "hint": ""}, "duration_ms": duration_ms, "metrics": extra_metrics}


def _build_delete_file_llm_data(exec_code, duration_ms, source="", detail="", extra_metrics=None):
    """delete_file的llm_data构建函数 — 小健 2026-06-21"""
    extra_metrics = extra_metrics or {}
    if exec_code == "error":
        return {"summary": f"删除失败: {detail}", "action": {"tool": "delete_file", "tool_zh": "删除", "target": source, "params": {}}, "status": {"exec_code": "error", "message": "删除失败", "code": "", "detail": detail, "hint": ""}, "duration_ms": duration_ms, "metrics": {}}
    return {"summary": f"删除成功: {source}", "action": {"tool": "delete_file", "tool_zh": "删除", "target": source, "params": {}}, "status": {"exec_code": "success", "message": "删除成功", "code": "", "detail": "", "hint": ""}, "duration_ms": duration_ms, "metrics": extra_metrics}


def _build_rename_file_llm_data(exec_code, duration_ms, source="", detail="", extra_metrics=None):
    """rename_file的llm_data构建函数 — 小健 2026-06-21"""
    extra_metrics = extra_metrics or {}
    if exec_code == "error":
        return {"summary": f"重命名失败: {detail}", "action": {"tool": "rename_file", "tool_zh": "重命名", "target": source, "params": {}}, "status": {"exec_code": "error", "message": "重命名失败", "code": "", "detail": detail, "hint": ""}, "duration_ms": duration_ms, "metrics": {}}
    return {"summary": f"重命名成功: {source}", "action": {"tool": "rename_file", "tool_zh": "重命名", "target": source, "params": {}}, "status": {"exec_code": "success", "message": "重命名成功", "code": "", "detail": "", "hint": ""}, "duration_ms": duration_ms, "metrics": extra_metrics}


def _build_read_data_file_llm_data(exec_code, duration_ms, file_path="", detected_format="", detail="", item_count=0):
    """read_data_file的llm_data构建函数 — 小健 2026-06-21"""
    if exec_code == "error":
        return {"summary": f"读取数据文件失败: {detail}", "action": {"tool": "read_data_file", "tool_zh": "读取数据", "target": file_path, "params": {}}, "status": {"exec_code": "error", "message": "读取失败", "code": "", "detail": detail, "hint": ""}, "duration_ms": duration_ms, "metrics": {}}
    return {"summary": f"已读取{detected_format.upper()}格式文件: {file_path}", "action": {"tool": "read_data_file", "tool_zh": "读取数据", "target": file_path, "params": {}}, "status": {"exec_code": "success", "message": "读取成功", "code": "", "detail": "", "hint": ""}, "duration_ms": duration_ms, "metrics": {"item_count": {"value": item_count, "text": f"{item_count}项"}} if item_count else {}}


def _build_write_data_file_llm_data(exec_code, duration_ms, file_path="", detected_format="", detail="", item_count=0):
    """write_data_file的llm_data构建函数 — 小健 2026-06-21"""
    if exec_code == "error":
        return {"summary": f"写入数据文件失败: {detail}", "action": {"tool": "write_data_file", "tool_zh": "写入数据", "target": file_path, "params": {}}, "status": {"exec_code": "error", "message": "写入失败", "code": "", "detail": detail, "hint": ""}, "duration_ms": duration_ms, "metrics": {}}
    return {"summary": f"已写入{detected_format.upper()}格式文件: {file_path}", "action": {"tool": "write_data_file", "tool_zh": "写入数据", "target": file_path, "params": {}}, "status": {"exec_code": "success", "message": "写入成功", "code": "", "detail": "", "hint": ""}, "duration_ms": duration_ms, "metrics": {"item_count": {"value": item_count, "text": f"{item_count}项"}} if item_count else {}}
...
def _build_delete_result(operation_id: str, path: Path, force: bool, method: str) -> dict:
    """构建删除操作的统一返回结果 - 小沈重构 2026-05-25, 小欧 2026-06-22 helper不构建llm_data"""
    delete_mode = "永久删除" if force else "放入回收站"
    return build_success(
        data={"operation_id": operation_id, "deleted_path": str(path), "delete_mode": delete_mode, "method": method},
    )
...
async def _read_text_file(
    ...
    """读取文本文件 — 小沈重构 2026-05-25, 小欧 2026-06-22 helper不构建llm_data
    返回纯业务数据,由调用方构建llm_data
    """
    try:
        is_binary, binary_reason = _is_binary_file(file_path)
        if is_binary:
            return build_error(data={"file_path": file_path, "error": f"{binary_reason}。请使用read_media_file工具读取媒体文件"})

        for _name, _val in [("head", head), ("tail", tail), ("offset", offset), ("limit", limit)]:
            if _val is not None and _val < 1:
                return build_error(data={_name: _val, "error": f"{_name}必须>=1,当前值: {_val}"})

        if head is not None and tail is not None:
            return build_error(data={"head": head, "tail": tail, "error": "head和tail不能同时使用"})

        if (head is not None or tail is not None) and (offset is not None or limit is not None):
            return build_error(data={"head": head, "tail": tail, "offset": offset, "limit": limit, "error": "head/tail与offset/limit不能同时使用"})

        is_valid, error_msg = _validate_path(file_path)
        if not is_valid:
            return build_error(data={"file_path": file_path, "error": error_msg})

        path = Path(file_path)
        if not path.exists():
            return build_error(data={"file_path": file_path, "error": f"文件不存在: {file_path}"})

        if not path.is_file():
            return build_error(data={"file_path": file_path, "error": f"路径不是文件: {file_path}"})

        file_size = path.stat().st_size
        if file_size > MAX_READ_SIZE:
            return build_error(data={"file_path": file_path, "file_size": file_size, "error": f"文件过大({file_size}字节),请使用head/tail分段读取"})

        content, used_encoding, error = await _try_read_file_with_encodings(path, encoding)
        if error:
            return build_error(data={"error_detail": error, "params": {"file_path": file_path}})
        ...
        return build_success(data=_data)

    except Exception as e:
        logger.error(f"read_text_file failed: {file_path}: {e}")
        return build_error(data={"error_detail": str(e), "params": {"file_path": file_path}})
...
async def list_directory(
    ...
    if format == "tree":
        ...
        if tree_result.get("code") == "SUCCESS" and "data" in tree_result:
            ...
            llm_data = _build_list_directory_llm_data("success", duration_ms, dir_path=dir_path, file_count=f, dir_count=d)
        else:
            detail = (tree_result.get("data") or {}).get("error", "未知错误")
            llm_data = _build_list_directory_llm_data("error", duration_ms, dir_path=dir_path, detail=detail)
        tree_result["llm_data"] = llm_data
        return tree_result
    ...
    try:
        ...
        result = _build_list_success(all_entries, total, path, statistics, start_offset, MAX_DISPLAY_ENTRIES)
        duration_ms = int((_time_mod.perf_counter() - t0) * 1000)
        truncated = total > MAX_DISPLAY_ENTRIES
        llm_data = _build_list_directory_llm_data("success", duration_ms, str(path), total, truncated)
...
async def _delete_file(
    ...
    """删除文件或目录 - 小健 2026-05-03, 小欧 2026-06-22 helper不构建llm_data"""
    ...
    try:
        if not path.exists():
            return build_success(data={"file_path": file_path, "status": "not_exists"})

        task_id = _current_task_id.get()
        if not task_id:
            return build_error(data={"file_path": file_path, "error": "当前没有活跃任务ID"})
        ...
        if is_ok:
            ...
            return build_error(data={"file_path": file_path, "error": "删除文件失败,safety拦截"})
...
async def _move_file(
    ...
    """移动或重命名文件 — 小健 2026-05-02, 小欧 2026-06-22 helper不构建llm_data"""
    is_valid_src, error_msg_src = _validate_path(source_path)
    if not is_valid_src:
        return build_error(data={"file_path": source_path, "error": f"源路径{error_msg_src}"})

    is_valid_dst, error_msg_dst = _validate_path(destination_path)
    if not is_valid_dst:
        return build_error(data={"file_path": destination_path, "error": f"目标路径{error_msg_dst}"})
    ...
    try:
        if not src.exists():
            return build_error(data={"file_path": source_path, "error": f"源文件不存在: {source_path}"})

        task_id = _current_task_id.get()
        if not task_id:
            return build_error(data={"file_path": source_path, "error": "当前没有活跃任务ID"})
        ...
        return build_error(data={"source": str(source_path), "destination": str(destination_path), "error": "移动文件失败"})

    except Exception as e:
        logger.error(f"Failed to move {source_path} -> {destination_path}: {e}")
        return build_error(data={"error_detail": str(e), "params": {"source": str(source_path), "destination": str(destination_path)}})
...
async def search_files(
    ...
    page_result = _paginate_search(all_matches, search_dir, llm_preview, DEFAULT_PAGE_SIZE, start_offset)
    duration_ms = int((_time_mod.perf_counter() - t0) * 1000)
    total = len(all_matches)
    llm_data = _build_search_files_llm_data("success", duration_ms, search_dir, total)
    page_result["llm_data"] = llm_data
    return page_result
...
async def _file_checksum(
    ...
    """计算文件校验和 — 小健 2026-06-22, 小欧 2026-06-22 helper不构建llm_data"""
...
async def _precise_replace_in_file(
        ...
        if not old_string:
            return build_error(data={"file_path": file_path, "error": "old_string不能为空,空字符串替换会导致内容爆炸"})
        ...
        is_binary, reason = _is_binary_file(file_path)
        if is_binary:
            return build_error(data={"file_path": file_path, "error": f"{reason}。请使用专业工具操作二进制文件"})

        t0 = _time_mod.perf_counter()
        try:
            is_valid, err = _validate_path(file_path)
            if not is_valid:
                return build_error(data={"file_path": file_path, "error": err})
            path = Path(file_path)
            if not path.exists():
                return build_error(data={"file_path": file_path, "error": f"文件不存在: {file_path}"})
            if path.stat().st_size > MAX_READ_SIZE:
                return build_error(data={"file_path": file_path, "file_size": path.stat().st_size, "error": f"文件过大({path.stat().st_size}字节),超过替换上限{MAX_READ_SIZE//1024//1024}MB"})
            ...
            duration_ms = int((_time_mod.perf_counter() - t0) * 1000)
            if not success:
                return build_error(data={"file_path": str(path), "error": "文件替换失败,safety拦截"})
            ...
            return build_error(data={"error_detail": f"替换失败: {e}", "params": {"file_path": file_path}})
...
async def _apply_edits(
    ...
    """高级编辑文件,支持多处编辑和预览(内部方法) — 小健 2026-05-25 重构拆分, 小欧 2026-06-22 helper不构建llm_data
    ...
    try:
        ...
        is_binary, binary_reason = _is_binary_file(file_path)
        if is_binary:
            return build_error(data={"file_path": file_path, "error": f"{binary_reason}。请使用对应的专业工具操作二进制文件"})
        ...
        if path.stat().st_size > MAX_READ_SIZE:
            return build_error(data={"file_path": file_path, "file_size": path.stat().st_size, "error": f"文件过大({path.stat().st_size}字节),超过编辑上限{MAX_READ_SIZE//1024//1024}MB"})
        ...
        return build_error(data={"file_path": file_path, "error": "文件编辑失败,safety拦截"})
    except Exception as e:
...
async def grep_file_content(
    ...
    try:
        ...
        return build_error(data={"error_detail": str(e), "params": {"pattern": pattern, "search_dir": str(search_dir)}}, llm_data=llm_data)
...
async def get_directory_tree(dir_path: str) -> Dict[str, Any]:
    """获取目录树(委托给 _get_directory_tree 实现)
        ...
        2026-06-22 小健 重构: 自行构建llm_data
        """
    t0 = _time_mod.perf_counter()
    result = await _get_directory_tree(dir_path)
    duration_ms = int((_time_mod.perf_counter() - t0) * 1000)
    if result.get("code") == "SUCCESS" and "data" in result:
        tree_data = result["data"]
        tree = tree_data.get("tree", {})
        llm_data = _build_directory_tree_llm_data("success", duration_ms, dir_path=dir_path, root_name=tree.get("name", ""), child_count=len(tree.get("children", [])))
    else:
        detail = (result.get("data") or {}).get("error", "未知错误")
        llm_data = _build_directory_tree_llm_data("error", duration_ms, dir_path=dir_path, detail=detail)
    result["llm_data"] = llm_data
    return result
...
async def _get_directory_tree(
    ...
    2026-06-22 小健 重构: 移除llm_data,返回纯业务数据,llm_data由调用工具构建"""
    try:
        is_valid, error_msg = _validate_path(dir_path)
        if not is_valid:
            return build_error(data={"file_path": dir_path, "error": error_msg})

        path = Path(dir_path)
        if not path.exists():
            return build_error(data={"file_path": dir_path, "error": f"目录不存在: {dir_path}"})
        if not path.is_dir():
            return build_error(data={"file_path": dir_path, "error": f"不是目录: {dir_path}"})
        ...
        return build_error(data={"error_detail": str(e), "params": {"dir_path": dir_path}, "error": str(e)})
...
async def read_text_file(
    ...
    """读取文本文件 — 小欧 2026-06-22 tool构建llm_data"""
    t0 = _time_mod.perf_counter()
    result = await _read_text_file(
        file_path=file_path,
        head=head,
        tail=tail,
        offset=offset,
    ...
    if result.get("code", "").startswith("ERR_"):
        llm_data = _build_read_text_file_llm_data("error", duration_ms, file_path=file_path, detail=result.get("message", "读取失败"))
    else:
        data = result.get("data", {})
        llm_data = _build_read_text_file_llm_data("success", duration_ms, file_path=file_path, line_count=data.get("line_count", 0), total_lines=data.get("total_lines", 0), file_size=data.get("file_size", 0))
    result["llm_data"] = llm_data
    return result
...
async def edit_text_file(
    ...
    duration_ms = int((_time_mod.perf_counter() - t0) * 1000)
    if result.get("code", "").startswith("ERR_"):
        llm_data = _build_edit_text_file_llm_data("error", duration_ms, file_path=file_path, detail=result.get("message", "编辑失败"))
    else:
...
async def extract_archive(
    ...
    """解压归档包 — 小沈 2026-06-16, 小健 2026-06-22 透传重新包装llm_data"""
    t0 = _time_mod.perf_counter()
...
async def move_file(
    ...
    """移动文件/目录 — 小沈 2026-06-16, 小欧 2026-06-22 tool构建llm_data"""
    t0 = _time_mod.perf_counter()
    ...
    if result.get("code") == "SUCCESS":
        ...
        return build_success(data=result.get("data", {}), llm_data=llm_data)
    llm_data = _build_move_file_llm_data("error", duration_ms, source, detail=result.get("message", "移动失败"))
    return build_error(data=result.get("data", {}), llm_data=llm_data)
...
async def copy_file(
    ...
    """复制文件/目录 — 小沈 2026-06-16, 小健 2026-06-20 删preserve_metadata; 透传重新包装llm_data"""
...
async def delete_file(
    ...
    """删除文件/目录 — 小沈 2026-06-16, 小欧 2026-06-22 tool构建llm_data"""
    t0 = _time_mod.perf_counter()
    ...
    duration_ms = int((_time_mod.perf_counter() - t0) * 1000)
    if result.get("code") == "SUCCESS":
        llm_data = _build_delete_file_llm_data("success", duration_ms, source)
        return build_success(data=result.get("data", {}), llm_data=llm_data)
    llm_data = _build_delete_file_llm_data("error", duration_ms, source, detail=result.get("message", "删除失败"))
    return build_error(data=result.get("data", {}), llm_data=llm_data)
...
async def rename_file(
    ...
    if src.name == new_name:
        llm_data = _build_rename_file_llm_data("success", 0, source, extra_metrics={"status": "no_change"})
...
def _build_format_result(
    ...
    """构建 data_file_format 的统一返回数据 — 小健 2026-06-21 helper不构建llm_data"""
    if result.get("code", "").startswith("ERR_"):
        return build_error(data={"file_path": file_path}), 0
...
async def _data_format_exec(
    ...
    if not dispatch:
        return build_error(data={"format": detected, "file_path": file_path})
    func = dispatch[action]
    if func is None:
        return build_error(data={"format": detected, "action": action, "file_path": file_path})
    try:
...
async def read_data_file(
    ...
    if not detected:
        ...
        return build_error(data={"file_path": file_path}, llm_data=llm_data)
    result = await _data_format_exec(file_path, "read", detected, encoding)
    return result
...
async def write_data_file(
    ...
    result = await _data_format_exec(file_path, "write", detected, encoding, data, indent)
    return result
...
def _paginate_search(all_matches: List, path: str, llm_preview: List,
    ...
    2026-06-22 小健 重构: 移除llm_data,返回纯业务数据,llm_data由search_files工具构建"""
    total = len(all_matches)
