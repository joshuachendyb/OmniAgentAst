...
def write_xlsx(
    ...
    try:
        ...
        llm_data = _build_write_xlsx_llm_data("error", duration_ms, str(path), detail=str(e), user_sheet_name=sheet_name, hint=hint)  # 小欧 2026-07-12: path已Path()重赋值,须str()防target泄漏WindowsPath
        return build_error(data={}, llm_data=llm_data)
