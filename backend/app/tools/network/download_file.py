...
async def download(
    ...
    try:
        ...
        if not is_valid:
            ...
            return build_error(data={"error_detail": detail, "params": {"url": url, "timeout": timeout}}, llm_data=llm_data)
        if warning_msg:
        ...
        try:
            ...
            return build_error(data={"error_detail": str(e), "params": {"url": url, "timeout": timeout}}, llm_data=llm_data)
