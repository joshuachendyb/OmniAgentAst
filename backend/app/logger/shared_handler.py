...
# -*- coding: utf-8 -*-
"""
shared_handler — 全局共享一个 SafeRotatingFileHandler 实例
- 原名 setup_logger.py，2026-07-26 改名 shared_handler.py（名实相符）
