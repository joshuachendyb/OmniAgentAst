...
**版本**: v0.15.9 | **更新时间**: 2026-06-12 10:09:14 | **作者**: 北京老陈团队
...
| 版本 | 日期 | 主要变更 |
|------|------|---------|
| **v0.15.9** | 2026-06-12 | CRSS关键词修复(txt/md/json→FILE)、write_text_file参数text→content统一、JSON混合提取容错、safety stub→真实file_safety委托、validate_config SLAP/DRY修复、version.txt空行跳过、E2E测试14/14通过 |
...
**许可**: 内部项目 | **最后更新**: 2026-06-12 10:09:14 | **版本**: v0.15.9
