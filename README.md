...
| 能力 | 说明 |
|------|------|
| **135个工具函数** | 覆盖文件、系统、网络、Shell、文档、桌面等7个分类 |
...
| 分类 | 说明 |
|------|------|
| **FILE** (file) | 文件读写、搜索、编辑、归档、压缩等 |
| **SHELL** (shell) | Shell命令执行、Python/JS代码执行 |
| **NETWORK** (network) | HTTP请求、下载、网页抓取、网络搜索、网络诊断 |
| **SYSTEM** (system) | 系统信息查询、进程管理、服务控制、环境变量、注册表 |
| **DESKTOP** (desktop) | 窗口管理、截屏、OCR、剪贴板、通知 |
| **DOCUMENT** (document) | PDF/Word/Excel读取、格式转换、SQL查询、数据分析、图表生成 |
| **META** (meta) | 工具帮助、工具搜索、时间日期、定时器 |
