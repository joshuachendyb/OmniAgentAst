...
> - **Phase 2**（9.3节）：只改observation模式，新增llm_data和tool_result字段
...
| **observation模式** | "observation" | **新增字段** | llm_data（完整）+ tool_result（完整data） |
...
**文档更新时间**: 2026-06-22 18:30:00  
**版本**: v7.0  
**编写人**: 小健 + 北京老陈 + 小欧  
**更新内容**: 
- v6.x: Phase 2设计逐步完善
- v7.0: **重大修改**：删除冗余字段，符合DRY原则
  - 删除顶层return_direct/warning/attachment字段（已在other_data中）
  - 前端从other_data取值
  - 代码示例更新
  - SSE格式更新
  - 前端适配代码更新
