...
from app.services.file_operations.agent import FileOperationAgent, AgentStatus, ThoughtStep, ActionToolStep, ObservationStep
...
class TestPagination:
    ...
    @pytest.mark.asyncio
    @pytest.mark.skip(reason="分页功能实现需要进一步验证")
...
class TestReActFlow:
    ...
    async def test_react_three_stages_independent(self):
        ...
        # 这个测试验证数据结构设计是否遵循原则
        from app.services.file_operations.agent import ThoughtStep, ActionToolStep, ObservationStep
    ...
    async def test_observation_contains_both_input_and_output(self):
        ...
        from app.services.file_operations.agent import ObservationStep
