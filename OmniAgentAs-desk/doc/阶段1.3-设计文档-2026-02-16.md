...
## 2.3 Windows 命令执行规则（基于实际测试）

> **参考文档**: 《Windows命令使用规则与测试报告.md》  
> **核心原则**: 不假设目标机器有 Git Bash，优先使用 Python 标准库

**本章位置调整说明**: 原 2.5 章调整为 2.3 章，保持章节顺序连续性（v1.2 修正）
...
## 2.4 日志与可观测性设计（遵循 v2.1 规范）

**本章位置调整说明**: 原 2.6 章调整为 2.4 章，保持章节顺序连续性（v1.2 修正）

> **参考规范**: 《开发策略规范-v2.1.md》第 3.5 章
